...
> **Downstream status:** this upstream journey is reference-only in Paseo Foundation.
...
[Foundation first run](../../docs/foundation-first-run.md). Manual Hub login/deploy vẫn dành cho trigger
...
Upstream journey runs Hub on your machine, connects it to Slack without a public server, and answers a mention with an agent in your repository. Upstream browser setup hands off to your terminal, and its `paseo hub init` writes and deploys a starter trigger.
