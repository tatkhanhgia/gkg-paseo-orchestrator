...
function roleIntentFields(
  options: Pick<CreateAgentRequestOptions, "roleId" | "assignment">,
): Pick<CreateAgentRequestOptions, "roleId" | "assignment"> {
  return {
