  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        ...
        continuity_notice: "إشعار انتباه",
      ...
      occurrenceCount_zero: "لم يظهر {{count}} مرة",
      occurrenceCount_one: "ظهر {{count}} مرة",
      occurrenceCount_two: "ظهر {{count}} مرتين",
      occurrenceCount_few: "ظهر {{count}} مرات",
      occurrenceCount_many: "ظهر {{count}} مرة",
      occurrenceCount_other: "ظهر {{count}} مرات",
      lastOccurredAt: "آخر ظهور {{time}}",
      lastOccurredAtExact: "الوقت الدقيق: {{time}}",
      historyToggleExpand: "إظهار {{count}} أقدم",
      historyToggleCollapse: "إخفاء السجل",
      detailsToggleShow: "إظهار التفاصيل",
      detailsToggleHide: "إخفاء التفاصيل",
      actionNeededLabel: "يتطلب إجراء",
      noActionNeededLabel: "لا يتطلب إجراء",
      resolution: {
        acknowledged: "إقرار",
        deferred: "تأجيل",
        declined: "رفض",
