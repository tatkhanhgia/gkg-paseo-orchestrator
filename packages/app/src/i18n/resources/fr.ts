...
export const fr: TranslationResources = {
  ...
  agentControls: {
    ...
    mode: {
      ...
      lockedOption: "Locked ({{mode}})",
      lockedHint: "This role assignment is pinned to a no-write mode and cannot be changed.",
    },
    hints: {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        ...
        continuity_notice: "Avis d'attention",
      ...
      occurrenceCount_zero: "Observé {{count}} fois",
      occurrenceCount_one: "Observé {{count}} fois",
      occurrenceCount_two: "Observé {{count}} fois",
      occurrenceCount_few: "Observé {{count}} fois",
      occurrenceCount_many: "Observé {{count}} fois",
      occurrenceCount_other: "Observé {{count}} fois",
      lastOccurredAt: "Dernière occurrence {{time}}",
      lastOccurredAtExact: "Heure exacte : {{time}}",
      historyToggleExpand: "Afficher {{count}} plus anciens",
      historyToggleCollapse: "Masquer l'historique",
      detailsToggleShow: "Afficher les détails",
      detailsToggleHide: "Masquer les détails",
      actionNeededLabel: "Action requise",
      noActionNeededLabel: "Aucune action requise",
      resolution: {
  ...
  hostTopology: {
    ...
    searchClearAccessibilityLabel: "Clear search",
    statusFilterAll: "All",
    statusFilterAccessibilityLabel: "Filter by status ({{status}})",
    projectFilterAll: "All projects",
    projectFilterAccessibilityLabel: "Filter by project ({{project}})",
    noMatches: "No agents match your search or filter.",
    agentAccessibilityLabel: "{{title}}, {{status}}",
  },
  toolCallDetails: {
    error: "Erreur",
  ...
  settings: {
    ...
    project: {
      ...
      projectHarness: {
        ...
        info: "Inspect and update daemon-guarded harness files for each registered workspace",
        unsupportedTitle: "Update this host to use Project Harness transactions",
        unsupportedDescription:
          "This daemon does not expose Project Harness transactions in Paseo yet.",
        noWorkspaceTitle: "No registered workspace target",
        noWorkspaceDescription:
          "Paseo will not guess an active workspace. Open a registered workspace before using Project Harness.",
        inspectFailedTitle: "Could not inspect Project Harness",
        inspectFailedDescription: "The host did not return the current harness inspection.",
        previewing: "Previewing...",
        previewBootstrap: "Preview bootstrap",
        previewUpdate: "Preview update",
        previewFailedTitle: "Could not preview Project Harness",
        previewFailedDescription: "The host did not return a guarded plan.",
        mutationFailedTitle: "Project Harness mutation failed",
        mutationFailedDescription: "The host did not complete the requested transaction.",
        rpcFailedDescription: "The host rejected the Project Harness operation.",
        relationship: "Entrypoint relationship",
        package: "Package",
        generation: "Generation",
        artifact: "Artifact digest",
        metadata: "Metadata",
        foreignOwnership: "Foreign ownership",
        foreignLocalDelta: "Foreign local deltas",
        foreignUnresolved: "Foreign unresolved",
        instructionCoverage: "Instruction coverage",
        instructionUnknown: "Instruction unknown",
        recovery: "Recovery",
        operation: "Operation",
        planDigest: "Plan digest",
        readyToApply: "Ready to apply",
        noChanges: "No changes in this guarded plan.",
        applying: "Applying...",
        ...
        freshReadback: "Fresh daemon readback received.",
        releaseWriter: "Release current writer",
        releaseWriterPending: "Releasing...",
        releaseWriterUnavailable: "Release unavailable",
        releaseWriterUnavailableDescription:
          "The daemon did not return a current supervisor writer; no release request was sent.",
        releaseFailedTitle: "Could not release Project Harness writer",
        releaseFailedDescription: "The host did not complete the release transaction.",
        readbackFailedTitle: "Mutation completed; fresh readback failed",
        readbackFailedDescription:
          "The daemon receipt is preserved. Inspect or reload the same target; do not retry the consumed plan.",
        releaseReadbackFailedTitle: "Release completed; fresh readback failed",
        releaseReadbackFailedDescription:
          "The release receipt is preserved. Inspect or reload before creating the successor.",
        releaseResult: "Release result",
        releasedWriter: "Released writer",
        nextStep: "Next step",
        releaseFreshReadback:
          "Fresh post-release inspection received. Create a fresh Supervisor before any notebook append.",
      },
      edit: {
