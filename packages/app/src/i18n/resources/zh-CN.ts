...
export const zhCN: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      questionLabel: "问题",
      occurrenceCount_zero: "出现 {{count}} 次",
      occurrenceCount_one: "出现 {{count}} 次",
      occurrenceCount_two: "出现 {{count}} 次",
      occurrenceCount_few: "出现 {{count}} 次",
      occurrenceCount_many: "出现 {{count}} 次",
      occurrenceCount_other: "出现 {{count}} 次",
      lastOccurredAt: "最近发生于 {{time}}",
      lastOccurredAtExact: "确切时间：{{time}}",
      historyToggleExpand: "显示另外 {{count}} 条更早的记录",
      historyToggleCollapse: "隐藏历史记录",
      detailsToggleShow: "显示详情",
      detailsToggleHide: "隐藏详情",
      actionNeededLabel: "需要处理",
