  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        ...
        continuity_notice: "Aviso de atenção",
      ...
      occurrenceCount_zero: "Visto {{count}} vezes",
      occurrenceCount_one: "Visto {{count}} vez",
      occurrenceCount_two: "Visto {{count}} vezes",
      occurrenceCount_few: "Visto {{count}} vezes",
      occurrenceCount_many: "Visto {{count}} vezes",
      occurrenceCount_other: "Visto {{count}} vezes",
      lastOccurredAt: "Última ocorrência {{time}}",
      lastOccurredAtExact: "Horário exato: {{time}}",
      historyToggleExpand: "Mostrar {{count}} anteriores",
      historyToggleCollapse: "Ocultar histórico",
      detailsToggleShow: "Mostrar detalhes",
      detailsToggleHide: "Ocultar detalhes",
      actionNeededLabel: "Requer ação",
      noActionNeededLabel: "Não requer ação",
      resolution: {
