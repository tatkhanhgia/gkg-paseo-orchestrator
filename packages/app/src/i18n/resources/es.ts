...
export const es: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        ...
        continuity_notice: "Aviso de atención",
      ...
      occurrenceCount_zero: "Visto {{count}} veces",
      occurrenceCount_one: "Visto {{count}} vez",
      occurrenceCount_two: "Visto {{count}} veces",
      occurrenceCount_few: "Visto {{count}} veces",
      occurrenceCount_many: "Visto {{count}} veces",
      occurrenceCount_other: "Visto {{count}} veces",
      lastOccurredAt: "Última vez {{time}}",
      lastOccurredAtExact: "Hora exacta: {{time}}",
      historyToggleExpand: "Mostrar {{count}} anteriores",
      historyToggleCollapse: "Ocultar historial",
      detailsToggleShow: "Mostrar detalles",
      detailsToggleHide: "Ocultar detalles",
      actionNeededLabel: "Requiere acción",
      noActionNeededLabel: "No requiere acción",
      resolution: {
  ...
  sidebar: {
    ...
    sections: {
      ...
      search: "Buscar",
      schedules: "Horarios",
      topology: "Topología del proyecto",
