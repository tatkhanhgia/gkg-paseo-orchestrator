  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        ...
        continuity_notice: "Attention notice",
      ...
      // _zero/_two/_few/_many exist only so TranslationResources (derived from
      // this file) admits the CLDR plural categories other locales need (e.g.
      // Arabic, Russian); English pluralization only ever selects one/other.
      occurrenceCount_zero: "Seen {{count}} times",
      occurrenceCount_one: "Seen {{count}} time",
      occurrenceCount_two: "Seen {{count}} times",
      occurrenceCount_few: "Seen {{count}} times",
      occurrenceCount_many: "Seen {{count}} times",
      occurrenceCount_other: "Seen {{count}} times",
      lastOccurredAt: "Last occurred {{time}}",
      lastOccurredAtExact: "Exact time: {{time}}",
      historyToggleExpand: "Show {{count}} earlier",
      historyToggleCollapse: "Hide history",
