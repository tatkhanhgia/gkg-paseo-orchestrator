  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        ...
        continuity_notice: "Уведомление о внимании",
      ...
      occurrenceCount_zero: "Замечено {{count}} раз",
      occurrenceCount_one: "Замечено {{count}} раз",
      occurrenceCount_two: "Замечено {{count}} раза",
      occurrenceCount_few: "Замечено {{count}} раза",
      occurrenceCount_many: "Замечено {{count}} раз",
      occurrenceCount_other: "Замечено {{count}} раз",
      lastOccurredAt: "Последний раз {{time}}",
      lastOccurredAtExact: "Точное время: {{time}}",
      historyToggleExpand: "Показать ещё {{count}}",
      historyToggleCollapse: "Скрыть историю",
      detailsToggleShow: "Показать подробности",
      detailsToggleHide: "Скрыть подробности",
      actionNeededLabel: "Требуется действие",
      noActionNeededLabel: "Действие не требуется",
      resolution: {
