...
export const ko: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      questionLabel: "질문",
      occurrenceCount_zero: "{{count}}회 발생",
      occurrenceCount_one: "{{count}}회 발생",
      occurrenceCount_two: "{{count}}회 발생",
      occurrenceCount_few: "{{count}}회 발생",
      occurrenceCount_many: "{{count}}회 발생",
      occurrenceCount_other: "{{count}}회 발생",
      lastOccurredAt: "마지막 발생 {{time}}",
      lastOccurredAtExact: "정확한 시간: {{time}}",
      historyToggleExpand: "이전 기록 {{count}}건 더 보기",
      historyToggleCollapse: "기록 숨기기",
      detailsToggleShow: "세부정보 표시",
      detailsToggleHide: "세부정보 숨기기",
      actionNeededLabel: "조치 필요",
      noActionNeededLabel: "조치 불필요",
      resolution: {
        acknowledged: "확인",
        deferred: "보류",
        declined: "거부",
