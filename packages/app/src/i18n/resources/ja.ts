...
export const ja: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      questionLabel: "質問",
      occurrenceCount_zero: "{{count}}回発生",
      occurrenceCount_one: "{{count}}回発生",
      occurrenceCount_two: "{{count}}回発生",
      occurrenceCount_few: "{{count}}回発生",
      occurrenceCount_many: "{{count}}回発生",
      occurrenceCount_other: "{{count}}回発生",
      lastOccurredAt: "最終発生 {{time}}",
      lastOccurredAtExact: "正確な時刻: {{time}}",
      historyToggleExpand: "他 {{count}} 件を表示",
      historyToggleCollapse: "履歴を非表示",
      detailsToggleShow: "詳細を表示",
      detailsToggleHide: "詳細を非表示",
      actionNeededLabel: "対応が必要",
      noActionNeededLabel: "対応不要",
      resolution: {
        acknowledged: "確認する",
        deferred: "延期する",
        declined: "却下する",
